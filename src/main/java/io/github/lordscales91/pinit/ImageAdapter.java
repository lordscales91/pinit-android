...
public class ImageAdapter extends BaseAdapter {
	...
	public ImageAdapter(Context c, String... urls) {
		mContext = c;
		this.urls = urls;
		this.failed = new boolean[urls.length];
	...
	public boolean hasImageLoadFailed(int position) {
		return this.failed[position];
	}

	private void setImageLoadFailedByURL(String url) {
		int position = -1;
		...
		ImageLoader.getInstance().displayImage(urls[position],
				holder.imageView, options, new SimpleImageLoadingListener() {
					...
					public void onLoadingFailed(String imageUri, View view,
						...
						setImageLoadFailedByURL(imageUri);
